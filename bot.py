...
# Carica il token e la porta da variabili d'ambiente
BOT_TOKEN = os.environ["BOT_TOKEN"]
PORT = int(os.environ.get("PORT", 5000))  # Render assegna la porta dinamicamente
...
# Avvio app Flask su Render
if __name__ == "__main__":
    import nest_asyncio
    nest_asyncio.apply()  # Necessario per usare asyncio.run dentro Flask su alcuni ambienti
    application.run_polling()  # non serve se usi solo webhook
